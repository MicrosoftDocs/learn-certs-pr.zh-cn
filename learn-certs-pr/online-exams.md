...
- 登录到 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。
...
分数报告可以从以下位置访问 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。

- 登录到 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。
-选择**查看我的分数报告**。在这里，您可以保存并打印分数报告。
...
要开始考试，请登录 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) 然后点击「开始以前安排的在线督导考试」。您将转到一个 Pearson VUE 网页，从中将看到您预约的考试，随后即可开始考试。
